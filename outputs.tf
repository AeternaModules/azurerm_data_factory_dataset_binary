...
output "data_factory_dataset_binaries_azure_blob_storage_location" {
  ...
  value       = { for k, v in azurerm_data_factory_dataset_binary.data_factory_dataset_binaries : k => one(v.azure_blob_storage_location) if v.azure_blob_storage_location != null && length(v.azure_blob_storage_location) > 0 }
}
output "data_factory_dataset_binaries_compression" {
  ...
  value       = { for k, v in azurerm_data_factory_dataset_binary.data_factory_dataset_binaries : k => one(v.compression) if v.compression != null && length(v.compression) > 0 }
}
...
output "data_factory_dataset_binaries_http_server_location" {
  ...
  value       = { for k, v in azurerm_data_factory_dataset_binary.data_factory_dataset_binaries : k => one(v.http_server_location) if v.http_server_location != null && length(v.http_server_location) > 0 }
}
...
output "data_factory_dataset_binaries_sftp_server_location" {
  ...
  value       = { for k, v in azurerm_data_factory_dataset_binary.data_factory_dataset_binaries : k => one(v.sftp_server_location) if v.sftp_server_location != null && length(v.sftp_server_location) > 0 }
}
